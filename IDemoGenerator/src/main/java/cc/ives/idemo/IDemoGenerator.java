...
//
//    private static SoftReference<List<IDItemInfo>> moduleClassCache;// 缓存所有的module类
//
//    /**
...
//        }
//
//        List<IDItemInfo> infoList = new ArrayList<>();
//
////        // 获取所有activity
...
//     * @return
//     */
//    public static List<IDItemInfo> getChildClassInfo(final Class preModule, String... packageNames){
//        scanModuleClass(packageNames);
//        List<IDItemInfo> allEntryClass = moduleClassCache.get();
//
//        List<IDItemInfo> children = new ArrayList<>();
//        Iterator<IDItemInfo> iterator = allEntryClass.iterator();
//        IDItemInfo itemEntryClz;
...
//     * @return
//     */
//    public static List<IDItemInfo> getRootClassInfo(String... packageNames){
...
//        List<IDItemInfo> methodClzInfos = new ArrayList<>();
//        IDItemInfo methodClzInfo;
//        IDAction annotation;
