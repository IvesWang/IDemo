...
public class IDLog {
    private static final String TAG = IDLog.class.getSimpleName();
    /**
    ...
    public static void e(String tag, Exception e) {
        if (null != e) {
            IDLog.e(tag, e.getClass().getCanonicalName() + " follow stack is:");
            StackTraceElement[] eles = e.getStackTrace();
            if (null != eles) {
                for (StackTraceElement stackTraceElement : eles) {

                    IDLog.e(tag, stackTraceElement.toString());
